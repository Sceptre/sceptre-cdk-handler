    ...
    def __init__(self, scope, id: str, sceptre_user_data: dict, **kwargs):
        ...
        self.my_lambda = PythonFunction(
            ...
            environment={
                ...
                'OTHER_ENVIRONMENT_VARIABLE': self.sceptre_user_data['special_variable']
            },
        )
        ...
        self.image_asset = aws_ecr_assets.DockerImageAsset(
            self,
            'CustomImage',
            directory=str(Path(__file__).parent / 'custom-image')
        )
        ...
        self.function_output = CfnOutput(self, 'OutputValue', value=self.my_lambda.function_arn)
