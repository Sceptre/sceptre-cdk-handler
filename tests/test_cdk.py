...
class TestCDK(TestCase):
    def setUp(self):
        ...
        self.sceptre_user_data = {"key": "value"}
        self.stack_group_config = {"project_path": "root_sceptre_dir"}
        ...
        self.bootstrapped_builder_class.return_value.build_template.return_value = (
            self.template_dict
        )
        self.bootstrapless_builder_class.return_value.build_template.return_value = (
            self.template_dict
        )
        self.cdk_json_builder_class.return_value.build_template.return_value = (
            self.template_dict
        )
        ...
        self.command_checker_class.return_value.node_package_exists.side_effect = (
            self.node_package_exists
        )
        ...
        self.node_packages = {"cdk-assets": True}
    ...
    def test_handle__class_name_as_argument__imports_named_class_from_specified_template_path(
        self,
    ):
        ...
        expected_template_path = Path(
            self.stack_group_config["project_path"], "templates", self.arguments["path"]
        )
        self.importer_class.return_value.import_class.assert_called_once_with(
            expected_template_path, "MyFancyClass"
        )

    def test_handle__no_class_name_argument__imports_default_class_name_from_template_path(
        self,
    ):
        self.validate_and_handle()
        ...
        self.importer_class.return_value.import_class.assert_called_once_with(
            expected_template_path, DEFAULT_CLASS_NAME
        )

    def test_handle__bootstrapped__bootstrap_qualifier_set__no_context__builds_template_with_qualifier_in_context(
        self,
    ):
        ...
        self.bootstrapped_builder_class.return_value.build_template.assert_called_once_with(
            expected_context, self.sceptre_user_data
        )

    def test_handle__bootstrapped__bootstrap_qualifier_set__has_context__builds_template_with_qualifier_in_context(
        self,
    ):
        self.arguments["deployment_type"] = "bootstrapped"
        self.arguments["bootstrap_qualifier"] = qualifier = "blardyblahr"
    ...
    def test_handle__bootstrapped__bootstrap_qualifier_in_context__builds_template_with_qualifier_in_context(
        self,
    ):
        self.arguments["deployment_type"] = "bootstrapped"
    ...
    def test_handle__bootstrapped__no_qualifier_but_has_context__builds_template_with_context(
        self,
    ):
    ...
    def test_handle__bootstrapped__no_qualifier_or_context__builds_template_with_no_context(
        self,
    ):
        self.arguments["deployment_type"] = "bootstrapped"
        self.validate_and_handle()
    ...
    def test_handle_bootstrapless__no_bootstrapless_config__builds_template_with_empty_bootstrapless_config(
        self,
    ):
    ...
    def test_handle__bootstrapless__bootstrapless_config__builds_template_with_bootstrapless_config(
        self,
    ):
        self.arguments["deployment_type"] = "bootstrapless"
        self.arguments["context"] = context = {"something": "else"}
    ...
    def test_handle__bootstrapped__path_is_to_cdk_json__builds_template_with_cdk_json_builder(
        self,
    ):
        self.arguments["deployment_type"] = "bootstrapped"
        self.arguments["context"] = context = {"something": "else"}
        self.arguments["path"] = path = self.arguments["path"].replace(
            "path.py", "cdk.json"
        )
    ...
    def test_handle__bootstrapped__path_is_relative_to_cdk_json__builds_template_with_cdk_json_builder(
        self,
    ):
        self.arguments["deployment_type"] = "bootstrapped"
        self.arguments["context"] = context = {"something": "else"}
    ...
    def test_handle__bootstrapless__path_is_to_cdk_json__builds_template_with_cdk_json_builder(
        self,
    ):
        self.arguments["deployment_type"] = "bootstrapless"
        self.arguments["context"] = context = {"something": "else"}
    ...
    def test_validate__additional_properties_defined_on_bootstrapless_config__raises(
        self,
    ):
        self.arguments["deployment_type"] = "bootstrapless"
